...
struct GenericFunctions {
    ...
    /// Returns true when both dates fall on the same calendar day but differ in hour or minute.
    static func isSameDayTimeDiffers(oldDate: Date, newDate: Date) -> Bool {
